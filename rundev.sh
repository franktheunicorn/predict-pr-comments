...
SPARK_EXEC_MEMORY=18g VERSION=full APP_NAME=$APP_PREFIX-$VERSION NUM_EXECS=20 SPARK_DEFAULT_PARALLELISM=30 MAIN_CLASS=com.holdenkarau.predict.pr.comments.sparkProject.ml.MlSCApp INPUT=gs://frank-the-unicorn/$VERSION/output OUTPUT=gs://frank-the-unicorn/$VERSION/ml ./run_spark_data_process.sh
